          ...
          })}
          {
            messages.length === 0 && (
              <div className="flex flex-wrap items-start gap-2 self-center">
                <AiChatSuggestion text="Show the overall summary of the data" onClick={async () => {
                  await appendWithChatOptions({ content: "Show the overall summary of the data", role: 'user' })
                }} />
                <AiChatSuggestion text="Show Charts" onClick={async () => {
                ...
                <AiChatSuggestion text="Question 3  " onClick={async () => {
